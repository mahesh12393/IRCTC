        ...
        while(option!=7){
            ...
            switch (option){
                case 1:
                    ...
                    User userToSignup = new User(signUpName, signUpPass, UserServiceUtil.hashPassword(signUpPass), UUID.randomUUID().toString(), new ArrayList<>());
                    try{
                ...
                case 2:
                    ...
                    Optional <User> foundUser = userBookingService.getUserByName(name);
                ...
                case 4:
                    ...
                    if (source == destination){
                        System.out.println("❌ Source and destination cannot be exactly same");
                        break;
                    }
                ...
                case 5:
                    ...
                    if(booked.equals(Boolean.TRUE)){
                        ...
                        System.out.println("Can't book this seat as it is already booked!");
                    }
                    break;
                case 6:
